...
function PlanSummary({ client }) {
  ...
  const handleFetchSummary = async () => {
    ...
    try {
      ...
      alert(
        'An error occurred while fetching the plan summary. Please try again.',
      );
    }
  };
        ...
        <Grid container spacing={3}>
          ...
          <Grid item sm={4}>
            ...
            <Typography level="body-sm">
              Metadata, actions and hooks configured
            </Typography>
            <Box
              mt={2}
              sx={{
            ...
            >
              ...
              <Typography level="body-sm">
                Period Time: {summary.plan.period_time}
              </Typography>
              <Typography level="body-sm">
                Max Failure Retry: {summary.plan.max_failure_retry}
              </Typography>
              <Typography level="body-sm">
                Created At: {new Date(summary.plan.created_at).toLocaleString()}
              </Typography>
              <Typography level="body-sm">
                Total tasks: {summary.tasks.length}
              </Typography>
              ...
              <Accordion sx={{ mt: 2 }}>
                ...
                <AccordionDetails>
                  ...
                  >
                    {summary.plan.hook.length > 0 ? (
                      summary.plan.hook.map((hook, index) => (
          ...
          <Grid item sm={4}>
            ...
            <Typography level="body-sm">
              All the tasks into which the plan was broken down into
            </Typography>
            <Box
              mt={2}
              sx={{
          ...
          <Grid item sm={4}>
            ...
            <Typography level="body-sm">
              Logs of errors that occured during execution of task/hook.
            </Typography>
            <Box
              mt={2}
              sx={{
